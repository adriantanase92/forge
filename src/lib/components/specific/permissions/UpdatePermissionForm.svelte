<script lang="ts">
	...
	const submitUpdate: SubmitFunction = async ({ data, cancel }) => {
	...
	<div class="modal-example-form {cBase}">
		...
		>
			<div class="wf__form__group">
				<label for="id" class="label hidden wf__form__label">Id</label>
				<input id="id" type="hidden" name="id" hidden value={permission.id} />
			</div>
			<div class="wf__form__group">
				...
				<input
					...
					value={form?.name ?? permission.name}
				/>
			</div>
		</form>
